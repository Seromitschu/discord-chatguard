                ...
                case "linktimeout":
                  {
                    ...
                    const timeoutEmbed = new EmbedBuilder()
                      .setTitle("Timeout")
                      .setDescription(
                        `${Emojis.WARN} You have received a timeout from \`${msg.guild.name}\` for sending more than 500 characters message.`
                      )
                      .setTimestamp();
                ...
                case "linkkick":
                  {
                    ...
                    const kickEmbed = new EmbedBuilder()
                      .setTitle("Kicked")
                      .setDescription(
                        `${Emojis.WARN} You have been kicked from \`${msg.guild.name}\` for sending more than 500 characters message.`
                      )
                      .setTimestamp();
