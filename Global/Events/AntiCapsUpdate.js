    ...
    async execute(oldMessage, newMessage, client) {
      ...
      if (requireDB.logs === true) {
        ...
        if (member.permissions.has(memberPerms)) return;
          ...
          if (
            newMessage.content.replace(capsLockRegex, "").length >=
                  ...
                  case "linktimeout":
                    {
                      ...
                      const timeoutEmbed = new EmbedBuilder()
                        .setTitle("Timeout")
                        .setDescription(
                          `${Emojis.WARN} You have received a timeout from \`${newMessage.guild.name}\` for sending caps lock.`
                        )
                        .setTimestamp();
                  ...
                  case "linkkick":
                    {
                      ...
                      const kickEmbed = new EmbedBuilder()
                        .setTitle("Kicked")
                        .setDescription(
                          `${Emojis.WARN} You have been kicked from \`${newMessage.guild.name}\` for sending caps lock.`
                        )
                        .setTimestamp();
                      ...
                      newMessage.member
                        ...
                        .then(() => {
                          newMessage.member.kick({ reason: "Sending caps lock." });
                        });
                    }
                    break;
                }
