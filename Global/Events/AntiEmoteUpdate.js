    ...
    async execute(oldMessage, newMessage, client) {
      ...
      if (requireDB.logs === true) {
        ...
        if (member.permissions.has(memberPerms)) return;
          ...
          if (emojiRegex.test(newMessage.content) && newMessage.content.match(emojiRegex).length > 3) {
            newMessage.delete();
                  ...
                  case "linktimeout":
                    {
                      ...
                      const timeoutEmbed = new EmbedBuilder()
                        .setTitle("Timeout")
                        .setDescription(
                          `${Emojis.WARN} You have received a timeout from \`${newMessage.guild.name}\` for sending more than 3 emote message.`
                        )
                        .setTimestamp();
                  ...
                  case "linkkick":
                    {
                      ...
                      const kickEmbed = new EmbedBuilder()
                        .setTitle("Kicked")
                        .setDescription(
                          `${Emojis.WARN} You have been kicked from \`${newMessage.guild.name}\` for sending more than 3 emote message.`
                        )
                        .setTimestamp();
